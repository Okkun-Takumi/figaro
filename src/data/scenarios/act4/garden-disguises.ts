...
export const gardenDisguises = {
  ...
  nodes: {
    ...
    "disguise-rejoin": { type: "dialogue", id: "disguise-rejoin", text: "そのとき、庭の向こうから誰かが近づく気配がした。ケルビーノが、スザンナの服を着た伯爵夫人を見つけようとしている。", presentation: { backgroundId: "garden-night", characters: [{ characterId: "countess", expressionId: "disguise", position: "left" }, { characterId: "susanna", expressionId: "disguise", position: "center" }, { characterId: "cherubino", expressionId: "surprised", position: "right" }] }, next: { sceneId: "susanna-deh-vieni", nodeId: "susanna-enters-garden" } },
  },
} satisfies Scene
