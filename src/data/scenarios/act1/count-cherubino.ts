...
export const countCherubino = {
  ...
  nodes: {
    ...
    "count-enters": { type: "dialogue", id: "count-enters", speakerId: "count", text: "「スザンナ。」", presentation: { ...susannaPresentation, characters: [{ characterId: "susanna", expressionId: "worried", position: "left" }, { characterId: "count", expressionId: "charming", position: "right" }] }, next: { nodeId: "susanna-greets-count" } },
    ...
    "count-notices": { type: "dialogue", id: "count-notices", speakerId: "count", text: "「ずいぶん慌てているようだな。」", presentation: { ...susannaPresentation, characters: [{ characterId: "susanna", expressionId: "worried", position: "left" }, { characterId: "count", expressionId: "charming", position: "right" }] }, next: { nodeId: "susanna-denies" } },
    ...
    "count-proposes": { type: "dialogue", id: "count-proposes", speakerId: "count", text: "「バジリオから聞いているだろう。私がお前をどれほど気に入っているか。」", presentation: { ...susannaPresentation, characters: [{ characterId: "susanna", expressionId: "neutral", position: "left" }, { characterId: "count", expressionId: "charming", position: "right" }] }, next: { nodeId: "susanna-refuses" } },
    ...
    "information-layout": { type: "dialogue", id: "information-layout", text: "今、この部屋では――\n\n表にいる：スザンナ\n隠れている：伯爵、ケルビーノ\n\n二人は同じ椅子の陰で、これからの会話を聞くことになる。互いに正体を知らないまま、事態はますますややこしくなっていく。", presentation: susannaPresentation, next: { nodeId: "basilio-enters" } },
