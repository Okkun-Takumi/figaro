...
const susannaPresentation = {
  ...
  characters: [{ characterId: "susanna", expressionId: "surprised", position: "center" as const }],
}
...
export const countCherubino = {
  ...
  nodes: {
    ...
    "cherubino-fears": { type: "dialogue", id: "cherubino-fears", speakerId: "cherubino", text: "「見つかったら本当に終わりだ！」", presentation: { ...susannaPresentation, characters: [{ characterId: "susanna", expressionId: "surprised", position: "left" }, { characterId: "cherubino", expressionId: "surprised", position: "right" }] }, next: { nodeId: "susanna-stops" } },
    ...
    "count-enters": { type: "dialogue", id: "count-enters", speakerId: "count", text: "「スザンナ。」", presentation: { ...susannaPresentation, characters: [{ characterId: "susanna", expressionId: "surprised", position: "left" }, { characterId: "count", expressionId: "smile", position: "right" }] }, next: { nodeId: "susanna-greets-count" } },
    ...
    "count-notices": { type: "dialogue", id: "count-notices", speakerId: "count", text: "「ずいぶん慌てているようだな。」", presentation: { ...susannaPresentation, characters: [{ characterId: "susanna", expressionId: "surprised", position: "left" }, { characterId: "count", expressionId: "smile", position: "right" }] }, next: { nodeId: "susanna-denies" } },
    ...
    "count-hides": { type: "dialogue", id: "count-hides", speakerId: "count", text: "「……バジリオ。ここにいるところを見られるのはまずい。」", presentation: { ...susannaPresentation, characters: [{ characterId: "susanna", expressionId: "surprised", position: "left" }, { characterId: "count", expressionId: "surprised", position: "right" }] }, next: { nodeId: "chair-confusion" } },
    ...
    "basilio-gossip": { type: "dialogue", id: "basilio-gossip", speakerId: "basilio", text: "「伯爵がスザンナを気に入っている話より、ケルビーノの方が面白い。食事の席でも、伯爵夫人をずっと見つめている。誰が見ても分かるくらいにね」", presentation: { ...susannaPresentation, characters: [{ characterId: "susanna", expressionId: "surprised", position: "left" }, { characterId: "basilio", expressionId: "smile", position: "right" }] }, effects: [{ type: "setFlag", key: "basilioGossipedAboutCherubino", value: true }, { type: "setFlag", key: "countHeardCherubinoRumor", value: true }], next: { sceneId: "cherubino-discovered", nodeId: "count-emerges" } },
  },
} satisfies Scene
