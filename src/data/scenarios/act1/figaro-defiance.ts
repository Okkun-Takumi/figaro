...
export const figaroDefiance = {
  ...
  nodes: {
    ...
    "figaro-song": { type: "dialogue", id: "figaro-song", speakerId: "figaro", text: "フィガロは低く、けれど確かな声で歌い始めた。伯爵へ向けた、挑戦の歌だった。", presentation: { ...presentation, musicId: "seVuolBallare" }, next: { nodeId: "song-after" } },
