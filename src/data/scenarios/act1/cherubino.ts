...
export const cherubino = {
  ...
  nodes: {
    ...
    "non-so-piu-title": { type: "dialogue", id: "non-so-piu-title", text: "♪ Non so più cosa son, cosa faccio", presentation: { ...flusteredPresentation, musicId: "nonSoPiu" }, next: { nodeId: "footsteps" } },
