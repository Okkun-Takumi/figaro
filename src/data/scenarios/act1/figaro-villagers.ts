...
export const figaroVillagers = {
  ...
  nodes: {
    ...
    "giovani-title": { type: "dialogue", id: "giovani-title", text: "♪ Giovani liete", presentation, next: { nodeId: "giovani-explanation" } },
    "giovani-explanation": { type: "dialogue", id: "giovani-explanation", text: "歌う人物：村人たち / 合唱。村人たちは花を撒きながら、伯爵が古い特権を放棄したことを称える。一見すると伯爵を褒める祝福の歌だ。", presentation, next: { nodeId: "giovani-point" } },
    "giovani-point": { type: "dialogue", id: "giovani-point", text: "【観劇ポイント】華やかな合唱だが、フィガロにとっては伯爵への政治的な圧力。皆の前で褒められるほど、伯爵はスザンナへ手を出しにくくなる。", presentation, effects: [{ type: "setFlag", key: "figaroPubliclyPressuredCount", value: true }, { type: "setFlag", key: "understandsFigaroPublicStrategy", value: true }], next: { nodeId: "figaro-praises" } },
