...
export const countessPlan = {
  ...
  nodes: {
    ...
    "garden-rendezvous-plan": { type: "dialogue", id: "garden-rendezvous-plan", speakerId: "susanna", text: "「私は伯爵様に、庭で会うと伝える。そうすれば伯爵は、きっと約束どおりに来るわ。」", presentation: countessSusannaPresentation, effects: [{ type: "setFlag", key: "knowsGardenRendezvousPlan", value: true }], next: { nodeId: "cherubino-disguise-plan" } },
